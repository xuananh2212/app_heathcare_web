...
export const menu = [
     ...
     { title: 'Nhóm bác sĩ', path: '/doctor-groups', icon: <HiUserGroup className='text-[20px] text-[#404040]' /> },
     ...
     { title: 'Đặt lịch khám', path: '/book-appoinments', icon: <FaBookOpen className='text-[20px] text-[#404040]' /> },
